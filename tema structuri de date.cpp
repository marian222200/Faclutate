...
int main(){
    ...
    t=clock();
    radix_sort(v,n,10);
    fout<<"Radix  sort timp:"<<clock()-t<<"\n";
    //fout<<verif_sort(v,n)<<"\n";
    copiere(v,cv,n);

    t=clock();
    merge_sort(v,n);
    fout<<"Merge  sort timp:"<<(clock()-t)<<"\n";
    //fout<<verif_sort(v,n)<<"\n";
    copiere(v,cv,n);

    t=clock();
    quick_sort(v,n);
    fout<<"Quick  sort timp:"<<clock()-t<<"\n";
    //fout<<verif_sort(v,n)<<"\n";
